...
export async function processAiResponses(sessionId: string): Promise<ProcessResult> {
 ...
 */
function classifyErrorSeverity(errorMessage: string): 'warning' | 'error' | 'critical' {
